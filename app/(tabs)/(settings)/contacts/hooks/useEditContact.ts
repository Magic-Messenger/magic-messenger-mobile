...
export const useEditContact = () => {
  ...
  const { contactUsername, nickname, barcode, isBlocked } =
  ...
  const { mutateAsync: blockAccount, isPending: isBlockPending } =
    usePostApiAccountBlockAccount();
  const { mutateAsync: unblockAccount, isPending: isUnblockPending } =
    usePostApiAccountUnblockAccount();
